...
public class EmPubLiteActivity extends Activity {
    ...
    private void setupPager(BookContents contents) {
        ...
        if (prefs != null) {
            //the second argument in prefs.getBoolean() is the default argument that if
            //the PREF_SAVE_LAST_POSITION was not true then it would return false otherwise true
            // if true we had to make changes to our app
